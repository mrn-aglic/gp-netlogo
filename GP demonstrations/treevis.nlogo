...
to get-code
  clear-output
  ;let preordered preorder-only-terminals testing-tree (remove-duplicates [label] of nodes with [count my-out-links = 0])
  let program join flatten testing-tree " "
  output-print program
end

to exec
  let program join flatten testing-tree " "
  let anon runresult (word "[ x -> " program " ]" )
  user-message (word "Test result for " param " is " (runresult anon param))
end
...
to draw
  ;set testing-tree ["sub" ["cos" ["safeDiv" ["x"] ["x"]]] ["neg" ["safeDiv" ["0.0"] ["0.0"]]]]
  ;set testing-tree ["commands" ["command" ["turn-left"]] ["commands" ["command" ["forward-1"]] ["commands" ["command" ["command" ["turn-left"]]] ["commands" ["turn-right"] ["commands" ["turn-left"] ["commands" ["command" ["command" ["command" ["command" ["command" ["turn-left"]]]]]] ["commands" ["forward-1"] ["command" ["command" ["forward-1"]]]]]]]]]]
  ;set testing-tree ["commands" ["forward-1"] ["commands" ["forward-1"] ["commands" ["turn-right"] ["commands" ["turn-right"] ["commands" ["forward-1"] ["commands" ["forward-1"] ["commands" ["turn-right"] ["commands" ["forward-1"] ["commands" ["turn-left"] ["commands" ["turn-right"] ["commands" ["turn-right"] ["commands" ["turn-left"] ["commands" ["turn-right"] ["command" ["turn-left"]]]]]]]]]]]]]]]
  ;set testing-tree ["add" ["add" ["add" ["add" ["x"] ["1.0"]] ["sin" ["x"]]] ["div" ["safe-log" ["1.0"]] ["add" ["x"] ["x"]]]] ["sin" ["safe-log" ["div" ["x"] ["1.0"]]]]]
  set testing-tree ["sub" ["cos" ["x"]] ["exp" ["mult" ["sub" ["1.0"] ["x"]] ["cos" ["1.0"]]]]]
